...
class BookstoreUserRegisterTests {
    ...
    @Test
    void registerNewUser() throws BookstoreUserExistException {
        ...
        assertTrue(EmailValidator.getInstance().isValid(user.getEmail()));
        assertTrue(Strings.isNotBlank(user.getName()));
        assertTrue(Strings.isNotBlank(user.getPhone()));
    ...
    @Test
    void registerNewUserFail() throws BookstoreUserExistException {
